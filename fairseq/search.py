...
class Sampling(Search):
    ...
    def step(self, step, lprobs, scores):
        ...
        #     out=self.scores_buf,
        # )
        self.scores_buf =  torch.gather( probs_nopad,dim=2,index=self.indices_buf.unsqueeze(-1),)
        ...
        if step == 0:
            ...
            self.beams_buf = torch.arange(0, beam_size).repeat(bsz, 1).to(self.device)
