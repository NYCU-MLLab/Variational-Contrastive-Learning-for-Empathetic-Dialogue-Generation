    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                # 原始為 exp_avg.mul_(beta1).add_(1 - beta1, grad)
                exp_avg_sq.mul_(beta2).addcmul_( grad, grad, value=(1 - beta2) )
                # 原始為 exp_avg_sq.mul_(beta2).addcmul_(1 - beta2, grad, grad)
                if amsgrad:
                ...
                if group['weight_decay'] != 0:
                    ...
                    #原始為 p_data_fp32.add_(-group['weight_decay'] * group['lr'], p_data_fp32)

                p_data_fp32.addcdiv_(exp_avg, denom, value= -step_size)
                # 原始為p_data_fp32.addcdiv_(-step_size, exp_avg, denom)
